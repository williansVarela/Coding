...
urlpatterns = [
    ...
    path('new_clinical_log/<int:pk>/', new_clinical_log, name='new_clinical_log_popup'),
    path('update_clinical_log/<int:pk>/', update_clinical_log, name='update_clinical_log'),
    path('del_clinical_log/<int:pk>/', del_clinical_log, name='del_clinical_log'),

    path('new_shelter/<int:pk>/', new_shelter, name='new_shelter'),
